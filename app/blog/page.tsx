...
export const metadata: Metadata = {
  ...
  description:
    "Discover expert guides on character headcanon creation, AI generator tips, anime character development, and fanfiction writing. Learn how to build compelling character backstories with our comprehensive blog articles.",
  robots: {
    index: true,
    follow: true,
    googleBot: {
