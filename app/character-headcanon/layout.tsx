...
export const metadata: Metadata = {
  ...
  description:
    "Create unique character headcanons with our free AI-powered generator. Explore backstories, personality traits, and hidden talents. Perfect for writers and fanfiction creators. Start generating now!",
  // 7. robots 元标签
  robots: {
    index: true,
    follow: true,
