  ...
  if (user) {
    ...
    return (
      <div className="ml-4 flex items-center gap-2">
        <div className="hidden sm:flex items-center gap-2 px-3 py-2 rounded-lg bg-gradient-to-r from-blue-50 to-purple-50 text-blue-700 border border-blue-200/50 shadow-sm">
          ...
          <span className="text-sm font-medium whitespace-nowrap max-w-[120px] truncate">{userName}</span>
        </div>
        <Button
          ...
          variant="outline"
          size="sm"
          className="h-9 text-gray-700 hover:bg-red-50 hover:border-red-200 hover:text-red-600"
          aria-label="Sign out"
        >
          {isLoggingOut ? (
